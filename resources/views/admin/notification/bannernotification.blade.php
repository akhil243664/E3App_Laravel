               ...
               <form action="{{route('admin.notification.storebanner')}}" method="post" enctype="multipart/form-data">
			    ...
			    <div class="col-lg-6 col-sm-12 col-xs-12 col-md-6">
                            <div class="mb-3">
                              ...
                              <input type="date" class="form-control" name="start_date" id="start_date" @if($n) value="{{date('Y-m-d', strtotime($n['start_date']))}}" @endif/>

                            </div></div>
				<div class="col-lg-6 col-sm-12 col-xs-12 col-md-6">
                            <div class="mb-3">
                              <label class="form-label required">End Date</label>
                               <input type="date" class="form-control" name="end_date" id="end_date" @if($n) value="{{date('Y-m-d', strtotime($n['end_date']))}}" @endif/>
