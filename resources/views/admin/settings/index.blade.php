              ...
              <div class="card-body">
                           ...
                           <label class="form-label required"> Country Selection</label>
                             <div class="mb-3">
                              ...
                              <select name="country_selection" class="form-control">
                                            <option value="1" @if($cs->active==1) selected @endif> Active</option>
                                            <option value="0"  @if($cs->active==0) selected @endif> InActive</option>
                                        </select>
                            </div>
                       </div>
                       @endif
               ...
               <center>
                    <img style="height: 100px;border: 1px solid #3399db; border-radius: 10px; padding: 11px;" id="viewer"
                        ...
                        src="{{asset('storage/app/public/info/'.$dummy_image->image)}}" alt="Dummy image"/>
                </center>
                <div class="mb-3">
