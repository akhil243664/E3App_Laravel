            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="flex">
                        ...
                        href="{{ route('admin.category.export-all') }}" class="btn btn-danger  float-right">Export All
                    </a>&nbsp;
                    <a align="right" style="float:right !important;" href="{{ route('admin.category.add') }}"
    ...
    @foreach ($categories as $key => $category)
        <div class="modal fade" id="exampleModal{{ $category->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <form action="{{ route('admin.category.update_cat_img', $category->id) }}" method="post"
