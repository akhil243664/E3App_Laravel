                      ...
                      <tr>
                          @foreach($homeads as $key=>$homead)
                                <tr>
                                    ...
                                    <td class="sort-name"> @if($homead->adv!= NULL){{$homead->adv->name}} @else <b style="color:red">Advertiser Deleted </b>@endif</td>
            ...
            <tbody class="tbody">
              ...
              @if(count($homeads)>0)
                ...
                <tr>
                  ...
                  <td class="ui-sortable-handle" style="border-radius: 0px 0px 0px 0px; background: #20E8C4;">@if($adminTopApps->adv!= NULL){{$adminTopApps->adv->name}}@else <b style="color:red">Advertiser Deleted </b>@endif</td>
