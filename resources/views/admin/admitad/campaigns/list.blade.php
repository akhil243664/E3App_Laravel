                    ...
                    <table id="example" class="display table-responsive" style="width:100%">
                        ...
                        <tbody class="table-tbody">
                            ...
                            <tr>
                                ...
                                <td class="sort-name">@if($e['partner']!=NULL) {{ Str::limit($e['partner']['name'], 30) }} @else <span style="color:red">Partner Not Available</span>@endif</td>
                               ...
                               if (window.confirm('Do you want to change the Status ?'))
                             {
                                ...
                                <td class="sort-type">
                                    ...
                                    <a href="{{route('admin.admitadcampaigns.edit',$e['id'])}}"
                                        class="btn btn-info"
