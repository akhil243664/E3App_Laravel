                             ...
                             @if(count($product->product_prices)>0)
                                ...
                                <div class="row">
                                    ...
                                    <label class="form-label required">Select Advertiser no. {{$l}}</label>
										<select name="morefields[{{$j}}][adv_id]" class="form-control" required>
                                   ...
                                   <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" name="morefields[{{$j}}][cashback]" id="validationCustom01" placeholder="Product Cashback" value="{{$fields['cashback']}}" required/></div>

                                     <div class="col-md-4">
                                    <label class="form-label required" for="validationCustom01">Campaign ID(required if partner is admitad or impact)</label>
                                    <input type="text" class="form-control" name="morefields[{{$j}}][c_id]" id="validationCustom01" placeholder="Campaign ID"  value="{{$fields['c_id']}}" required/>
                                   
                                    </div>
									
                                    <div class="col-md-4">
                                    <label class="form-label required" for="validationCustom01">Product MRP</label>
                                    <input type="number" class="form-control" name="morefields[{{$j}}][mrp]" id="validationCustom01" placeholder="Product MRP"  value="{{$fields['mrp']}}" required/>
                                    ...
                                    <input type="number" class="form-control" name="morefields[{{$j}}][price]" id="validationCustom01" placeholder="Product Price"  value="{{$fields['price']}}" required/>
                                    ...
                                    <input type="text" class="form-control" name="morefields[{{$j}}][url]" id="validationCustom01"  placeholder="Product URL"  value="{{$fields['url']}}" required/>
