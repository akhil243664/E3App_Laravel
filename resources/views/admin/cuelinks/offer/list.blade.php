...
@section('title','Cuelinks Offers List')
                            ...
                            <tr>
                                ...
                                <label class="form-check form-check-single form-switch" for="stocksCheckbox{{$e->id}}">
                                    <input type="checkbox" class="form-check-input"
                                        onclick="myFunctionss{{$e->id}}()" id="stocksCheckbox{{$e->id}}"
                                        {{$e->status?'checked':''}}>
                                </label>
                               
                                <script>
                                    function myFunctionss{{$e->id}}() {
                                ...
                                <td class="sort-role">
                                    <center><label class="form-check form-check-single form-switch"
                                            for="stocksCheckboxs{{$e->id}}">
                                            <input type="checkbox" class="form-check-input"
                                                onclick="myFunction{{$e->id}}()" id="stocksCheckboxs{{$e->id}}"
                                                {{$e->exclusive?'checked':''}}>
                                        </label>
                                    </center>
                                    <script>
