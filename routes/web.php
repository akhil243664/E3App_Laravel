...
Route::get('change-country', 'SystemController@change_country')->name('changeCountry');
});
...
Route::group(['prefix' => 'install'], function () {
   ...
   Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::get('admitadorderfetch', 'AdmitadOrderController@index')->name('admitadorderfetch');
	   ...
	   Route::group(['prefix' => 'cuelinksadvertisers', 'as' => 'cuelinksadvertisers.', 'middleware' => ['module:cuelink']], function () {
        ...
        Route::group(['prefix' => 'country', 'as' => 'country.'], function () {
            Route::group(['middleware' => ['module:country']], function () {
                Route::get('index', [CountryController::class, 'list'])->name('index');
                ...
                Route::get('active_status/{id}/{status}', [CountryController::class, 'active_status'])->name('active_status');                
            });
        });
	     ...
	     Route::group(['prefix' => 'fbads', 'as' => 'fbads.', 'middleware' => ['module:fbads']], function () {
            ...
            Route::group(['prefix' => 'admitadcampaigns', 'as' => 'admitadcampaigns.', 'middleware' => ['module:admitad']], function () {
             ...
             Route::get('status/{admitad}/{status}', 'AdmitaddataController@status')->name('status');
				 Route::get('delete/{id}', 'AdmitaddataController@distroy')->name('delete');
                 Route::get('edit/{id}', 'AdmitaddataController@edit')->name('edit');
                 Route::post('update/{id}', 'AdmitaddataController@update')->name('update');
