...
Route::group(['namespace' => 'Api'], function () {
     ...
     Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::put('reset-password', 'PasswordResetController@reset_password_submit');
		 ...
		 Route::post('login_with_email', 'AuthCustomerController@login_with_email');
	...
	Route::get('country_list', 'ConfigController@country_list');
	Route::post('update_country', 'ConfigController@update_country');
	Route::get('language_list', 'ConfigController@language_list');



	  Route::get('floxypay', 'FloxyController@floxypay'); 
