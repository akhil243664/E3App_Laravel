<?php $__env->startSection('title','Update Admob'); ?>
          ...
          <div class="container-xl">
            ...
            <div class="card">
                <div class="card-header"><h2 class="page-title">
                 <?php echo e('Update Admob Settings'); ?>

                </h2>
               </div>
              <div class="card-body">
				 <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12"> 
              <button class="collapsible"><?php echo e('Banner Ads'); ?></button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/e3appvuu/public_html/e3-admin/resources/views/admin/ad_networks/settings.blade.php ENDPATH**/ ?>