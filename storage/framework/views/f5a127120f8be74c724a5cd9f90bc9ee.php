                  ...
                  <table id="example" class="display" style="width:100%">
                    <thead>
                      <tr>
                        ...
                        <th><button class="table-sort" data-sort="sort-phone">Order ID</button></th>
                        <th><button class="table-sort" data-sort="sort-phone">Merchant ID</button></th>
                           ...
                           <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="sort-email"> <?php echo e($e['order_id']); ?>
                                        ...
                                        <td class="sort-email"> <?php echo e($e['merchant_id']); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/customer/withdrawreq.blade.php ENDPATH**/ ?>