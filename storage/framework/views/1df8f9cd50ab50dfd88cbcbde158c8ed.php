				       ...
				       <div class="form-group"  id="viewerbox" style="display:none;margin-bottom:0%;">
						   <center>
							   <img style="width: 200px;border: 1px solid #3399db; border-radius: 10px; padding: 11px;" id="viewer"
									<?php if(isset($faq)): ?>
									src="<?php echo e(asset('storage/app/public/faq')); ?>/<?php echo e($faq['image']); ?>"
									<?php else: ?>
				           ...
				           <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="ques" id="ques" value="<?php echo e(old('ques')); ?>"/>
                            </div>
					       </div>
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                             <div class="mb-3">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/faq/index.blade.php ENDPATH**/ ?>