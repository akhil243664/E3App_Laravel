		...
		<form action="<?php echo e(route('admin.customer.update_img',$e->id)); ?>" method="post" enctype="multipart/form-data">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel<?php echo e($e->id); ?>" align="left">Add Extra Data</h5>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/customer/list.blade.php ENDPATH**/ ?>