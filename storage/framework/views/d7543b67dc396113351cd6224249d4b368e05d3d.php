                      ...
                      <tr>
                          <?php $__currentLoopData = $homeads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$homead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="sort-name"> <?php echo e($homead->adv->name); ?></td>
            ...
            <tbody class="tbody">
              ...
              <?php if(count($homeads)>0): ?>
                ...
                <tr>
                  ...
                  <td class="ui-sortable-handle" style="border-radius: 0px 0px 0px 0px; background: #20E8C4;"><?php echo e($adminTopApps->adv->name); ?></td>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/lpabdgkz/public_html/e3app.in/e3-admin/resources/views/admin/heading/list.blade.php ENDPATH**/ ?>