              ...
              <div class="card-body">
				  <div class="row">
				   ...
				   <a href="<?php echo e(route('admin.admitad')); ?>" onclick="return confirm('Are you sure?')" class="btn btn-success">Import Campaigns</a>
					     <a href="<?php echo e(route('admin.couponfetch')); ?>" onclick="return confirm('Are you sure?')" class="btn btn-success">Import Coupons</a>
                   </div>
					  <hr>
					<b><p style="color:red">Note:If any campaign does not have the category defined, then the system will assign or create it automatically.</p></b>
					  ...
					  <?php endif; ?>
					   <?php if($logo3): ?>
					   <p style="color:grey;font-size: 15px;">Coupons Last Updated on : <?php echo e(date('F jS, Y', strtotime($logo3->created_at))); ?></p>
					  <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/admitad/settings.blade.php ENDPATH**/ ?>