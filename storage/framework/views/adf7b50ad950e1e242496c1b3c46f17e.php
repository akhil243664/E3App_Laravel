                    ...
                    <table id="example" class="display table-responsive" style="width:100%">
                        ...
                        <tbody class="table-tbody">
                            ...
                            <tr>
                                ...
                                <td class="sort-name"><?php if($e['partner']!=NULL): ?> <?php echo e(Str::limit($e['partner']['name'], 30)); ?> <?php else: ?> <span style="color:red">Partner Not Available</span><?php endif; ?></td>
                               ...
                               if (window.confirm('Do you want to change the Status ?'))
                             {
                                ...
                                <td class="sort-type">
                                    ...
                                    <a href="<?php echo e(route('admin.admitadcampaigns.edit',$e['id'])); ?>"
                                        class="btn btn-info"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E3App_Laravel\admin\resources\views/admin/admitad/campaigns/list.blade.php ENDPATH**/ ?>