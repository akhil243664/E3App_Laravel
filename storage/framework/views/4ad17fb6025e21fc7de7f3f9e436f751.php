            ...
            <div class="card">
                 <div class="card-header"><h2 class="page-title" align="left" style="width: 100%;">
                  Clicks List
					 ...
					 <a href="<?php echo e(route('admin.customer.deleteclicks')); ?>" class="btn btn-secondary">Delete clicks older then ten days</a></div></div>
              <div class="card-body">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/customer/clicks.blade.php ENDPATH**/ ?>