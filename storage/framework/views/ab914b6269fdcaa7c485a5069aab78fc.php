...
<?php $__env->startSection('title','Add New Ad'); ?>
...
<?php $__env->startSection('content'); ?>
          ...
          <div class="container-xl">
            <div class="card">
              ...
              <div class="card-body">
               <form action="<?php echo e(route('admin.ads.added')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="button_text" id="button_text" value="<?php echo e(old('button_text')); ?>" placeholder="ex: grab deal"/>
                            </div>
                            <div class="mb-3">
                              <label class="form-label required">Button URL</label>
                              <input type="text" class="form-control" name="button_url" id="button_url" value="<?php echo e(old('button_url')); ?>" placeholder="ex: https:://xyz.com"/>
                            </div>
                              ...
                              <div class="form-group"  id="viewerbox" style="display:none;margin-bottom:0%;">
                                <center>
                                    <img style="width: 200px;border: 1px solid #3399db; border-radius: 10px; max-height:200px; padding: 11px;" id="viewer"
                                            src="<?php echo e(asset('public/theme_assets/img')); ?>/upload1.png" alt="offer banner"/>
                                </center>
                            </div>
                            
                             <div class="mb-3">
                            <div class="form-label">Ad Banner <small style="color: red">* (Ratio=> 1:1)</small></div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/partner/offer/add-new.blade.php ENDPATH**/ ?>