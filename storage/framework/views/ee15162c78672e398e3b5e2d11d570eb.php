                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.admitadcampaigns.update', [$campain['id']])); ?>" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo e($campain['name']); ?>" readonly />
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E3App_Laravel\admin\resources\views/admin/admitad/campaigns/edit.blade.php ENDPATH**/ ?>