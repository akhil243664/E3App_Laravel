               ...
               <form action="<?php echo e(route('admin.referral-settings.update-referral')); ?>" method="post" enctype="multipart/form-data">
				   ...
				   <div class="row">    
				    <div class="col-lg-6 col-sm-12 col-xs-12 col-md-6">
						 <?php ($signup=\App\Models\BusinessSetting::where('key','signup_refer')->where('country_slug', $admin->country_slug)->first()); ?>
                    
						
                            <div class="mb-3">

                              <label class="form-label required">Sign-up Referral</label>
					    ...
					    <div class="col-lg-6 col-sm-12 col-xs-12 col-md-6">
                        <?php ($per_order_refer_percentage=\App\Models\BusinessSetting::where('key','per_order_refer_percentage')->where('country_slug', $admin->country_slug)->first()); ?>
                              <div class="mb-3">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/settings/referral.blade.php ENDPATH**/ ?>