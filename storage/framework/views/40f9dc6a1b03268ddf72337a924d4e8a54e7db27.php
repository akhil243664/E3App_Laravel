    ...
    <div class="navbar navbar-light">
      <div class="container-xl">
        <ul id="myMenu" class="navbar-nav" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li
            class="nav-item dropdown <?php echo e(Request::is('smtp-settings/smtp-info')?'active':''); ?>  <?php echo e(Request::is('admin/info-settings/info-setup*')?'active':''); ?>  <?php echo e(Request::is('admin/banner*')?'active':''); ?> <?php echo e(Request::is('admin/homeadv*')?'active':''); ?> <?php echo e(Request::is('admin/allin*')?'active':''); ?><?php echo e(Request::is('admin/faq*')?'active':''); ?><?php echo e(Request::is('admin/coupon*')?'active':''); ?>">
            <a class="nav-link dropdown-toggle" href="#settings" data-bs-toggle="dropdown" data-bs-auto-close="outside"
              role="button" aria-expanded="false">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-adjustments" width="24"
                ...
                <div class="dropdown-menu-column">
                  ...
                  <a class="dropdown-item <?php echo e(Request::is('admin/info-settings/info-setup')?'active':''); ?>"
                    href="<?php echo e(Route('admin.info-settings.info-setup')); ?>">Master Settings</a>
                     <a class="dropdown-item <?php echo e(Request::is('smtp-settings/smtp-info')?'active':''); ?>"
                    href="<?php echo e(Route('admin.smtp-settings.smtp-setup')); ?>">SMTP Settings</a>
                  <?php endif; ?>
...
</div><?php /**PATH /home1/lpabdgkz/public_html/e3app.in/e3-admin/resources/views/admin/layout/navbar.blade.php ENDPATH**/ ?>