            ...
            <form class="form-group" action="<?php echo e(route('admin.country.update',$country->id)); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                              <div class="form-group">
                                    ...
                                    <input type="checkbox" name="admitad" <?php if(isset($admitad) && $admitad->status == 1): ?> checked <?php endif; ?>> <span>Admitted</span>
                                    <input type="checkbox" name="cuelink" <?php if(isset($cuelink) && $cuelink->status == 1): ?> checked <?php endif; ?>> <span>Cuelink</span>
                                    <input type="checkbox" name="impact" <?php if(isset($impact) && $impact->status == 1): ?> checked <?php endif; ?>> <span>Impact</span>
                                </div>                                             
                                <div class="form-group">
                                ...
                                <input type="text" class="form-control no-space" name="slug"  value="<?php echo e($country->slug); ?>"  >        
                                </div>                    
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/e3appvuu/public_html/e3-admin/resources/views/admin/country/edit.blade.php ENDPATH**/ ?>