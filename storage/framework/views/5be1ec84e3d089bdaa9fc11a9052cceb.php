                    ...
                    <tbody class="table-tbody">
                           ...
                           <?php $__currentLoopData = $reqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="sort-name"><?php if($e->user != NULL): ?> <?php echo e($e->user['name']); ?> <?php else: ?> <b style="color:red"> User Deleted <?php endif; ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>