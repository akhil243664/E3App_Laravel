				   ...
				   <div class="mb-3">
                             ...
                             <select name="status" class="form-control">
								 <option value="1" <?php if($cuelink->status==1): ?> selected <?php endif; ?>>Active</option>
								  <option value="0" <?php if($cuelink->status==0): ?> selected <?php endif; ?>>Inactive</option>
					        </select>
                            </div>
							 <div class="mb-3">

                              <label class="form-label required">Cuelinks Channel ID</label>
                              <input type="text" class="form-control" name="channel" id="channel" value="<?php echo e($cuelink->channel_id); ?>" placeholder="234233" />
                            </div>
                            <div class="mb-3">

                              <label class="form-label required">Cuelinks API Key</label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/cuelinks/settings.blade.php ENDPATH**/ ?>