               ...
               <form action="<?php echo e(route('admin.notification.storebanner')); ?>" method="post" enctype="multipart/form-data">
			    ...
			    <div class="col-lg-6 col-sm-12 col-xs-12 col-md-6">
                            <div class="mb-3">
                              ...
                              <input type="date" class="form-control" name="start_date" id="start_date" <?php if($n): ?> value="<?php echo e($n['start_date']); ?>" <?php endif; ?>/>
                            </div></div>
				<div class="col-lg-6 col-sm-12 col-xs-12 col-md-6">
                            <div class="mb-3">
                              <label class="form-label required">End Date</label>
                              <input type="date" class="form-control" name="end_date" id="end_date"  <?php if($n): ?> value="<?php echo e($n['end_date']); ?>" <?php endif; ?>/>
                            </div></div>
					<div class="col-lg-6 col-sm-12 col-xs-12 col-md-6">
                            <div class="mb-3">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/e3appvuu/public_html/e3-admin/resources/views/admin/notification/bannernotification.blade.php ENDPATH**/ ?>