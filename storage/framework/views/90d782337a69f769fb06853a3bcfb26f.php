                        ...
                        <?php echo csrf_field(); ?>
                           ...
                           <hr>
                            <div class="row">
								...
								<div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="cuelink" class="form-check-input"
                                               id="cuelink">
                                        <label class="form-label " for="cuelink">Cuelinks</label>
                                    </div>
                                </div><div class="col-md-3">
                                    <div class="form-group form-check">
								...
								<div class="col-md-3">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="modules[]" value="products" class="form-check-input"
                                               id="products">
                  ...
                  <table id="example" class="display" style="width:100%">
                    <thead>
                      <tr>
                        ...
                        <th><button class="table-sort" data-sort="sort-name">Role Name</button></th>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/custom-role/create.blade.php ENDPATH**/ ?>