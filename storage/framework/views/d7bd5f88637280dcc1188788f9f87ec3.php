<?php $__env->startSection('title','Cuelinks Coupon List'); ?>
							...
							<img src="<?php echo e(asset('storage/app/public/partner')); ?>/<?php echo e($coupon['image']); ?>" alt="no image" style="width:80px">
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-end">
										...
										<?php else: ?>
										<p><b>Cuelinks Offer Coupon<br>(<?php echo e(Str::limit($coupon->offers->name, 20,'...')); ?>)</b></p>
									<?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/cuelinks/cue_coupon.blade.php ENDPATH**/ ?>