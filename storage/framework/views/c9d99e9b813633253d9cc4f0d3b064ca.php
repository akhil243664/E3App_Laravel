...
?>
 <header class="navbar navbar-expand-md navbar-light d-none d-lg-flex d-print-none navbar-fixed fixed">
   ...
   <path d="M9 17v1a3 3 0 0 0 6 0v-1"></path>
              ...
              <?php if(auth('admin')->user()->role_id == 1): ?>
                ...
                <select class="form-control changeCountry">
                    <?php $__currentLoopData = $de_co; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $de_country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($de_country->slug); ?>" <?php if(auth('admin')->user()->country_slug==$de_country->slug): ?> selected <?php endif; ?>><?php echo e($de_country->country_name); ?> </option>
                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              <?php else: ?>
                   
                   <?php echo e(auth('admin')->user()->country_slug); ?>
    ...
    var url2 = "<?php echo e(route('changeCountry')); ?>";
...
<?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/layout/header.blade.php ENDPATH**/ ?>