...
<?php $__env->startSection('title','Add New Advertiser'); ?>
               ...
               <form action="<?php echo e(route('admin.advertiser.store')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
				     ...
				     <div class="mb-3">
                              ...
                              <input type="phone" class="form-control" name="left_tab" id="left_tab" value="<?php echo e(old('left_tab')); ?>" placeholder="Example: Reward Rates"/>
                            </div>
                             <div class="mb-3">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/partner/index.blade.php ENDPATH**/ ?>