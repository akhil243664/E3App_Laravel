<?php $__env->startSection('title','Cuelink Campaign List'); ?>
        ...
        <form action="<?php echo e(route('admin.cuelinkscampaigns.update_cam_img',$e->id)); ?>" method="post"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="form-label">Campaign Banner <small style="color: red">* (Ratio=> 1:1)</small></div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/cuelinks/campaigns/list.blade.php ENDPATH**/ ?>