               ...
               <form action="<?php echo e(route('admin.coupon.store')); ?>" method="post" enctype="multipart/form-data">
				   ...
				   <div class="row">
				    ...
				    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						  ...
						  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				             <div class="mb-3">
                                       <label class="form-label required">Coupon Description</label>
				    ...
				    <div class="row">
						  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				              <div class="mb-3">
                                        ...
                                        <select name="adv_id" class="js-data-example-ajax form-control"  title="Select Advertiser">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u727738086/domains/thecloudstories.com/public_html/admin/resources/views/admin/coupon/index.blade.php ENDPATH**/ ?>