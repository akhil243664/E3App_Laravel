<?php $__env->startSection('title','Update Facebook Ad Settings'); ?>
...
<?php $__env->startSection('content'); ?>
                  ...
                  <table id="example1" class="display" style="width:100%">
                    ...
                    <tbody class="table-tbody" >
                          <?php $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ban): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="sort-id"><?php echo e($ban->placement_id); ?></td>
	...
	<div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">	  
            ...
            <div class="content">
				 ...
				 <form action="<?php echo e(route('admin.fbads.update',$interstitial->id)); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
					<div class="row">
					  ...
					  <div class="row">
                                     <div class="col-12 col-lg-6 col-md-6"  style="float:left">
                                         <div class="mb-3">
                                            ...
                                            <input type="text" name="placement_id" class="form-control" placeholder="" value="<?php echo e($interstitial->placement_id); ?>" required>
                                         </div>
...
<?php $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ban): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="modal fade" id="exampleModal<?php echo e($ban->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel<?php echo e($ban->id); ?>" aria-hidden="true">
								  <div class="modal-dialog" role="document">
									   <form action="<?php echo e(route('admin.fbads.update',$ban->id)); ?>" method="post" enctype="multipart/form-data">
                                         <?php echo csrf_field(); ?>
									<div class="modal-content">
									  ...
									  <div class="modal-body">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12">
                                         <div class="mb-3">
                                            <label class="form-label required" for="exampleFormControlInput1">Placement ID</label>
                                            <input type="text" name="placement_id" class="form-control"  value="<?php echo e($ban->placement_id); ?>" required>
                                         </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/e3appvuu/public_html/e3-admin/resources/views/admin/ad_networks/fb.blade.php ENDPATH**/ ?>