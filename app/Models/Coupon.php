...
class Coupon extends Model
{
    use HasFactory;
	   ...
	   protected $fillable = [
    'name','status','code','adv_id','admi_coupon_id','image', 'description', 'heading', 'url', 'start_date', 'end_date', 'affiliate_partner','banner_image','button_text','created_at','updated_at','country_slug'
]; 
