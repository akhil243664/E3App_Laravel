...
class ProductController extends Controller
{
    function index()
    {
        ...
        $products=Product::where('country_slug',$admin->country_slug)->latest()->paginate(15);
	...
	$admin = Admin::find(auth('admin')->id());
        ...
        ->orderBy('id','desc')->where('country_slug',$admin->country_slug)->paginate(10);
 ...
 public function update_cat_img(Request $request, $id)
    ...
    function store(Request $request)
    {
        ...
        $product->country_slug = $admin->country_slug;
