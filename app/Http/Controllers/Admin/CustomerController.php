...
class CustomerController extends Controller
{
	 ...
	 public function withdraw_requests(Request $request)
    {
        ...
        $customers = WithdrawalReq::with('user')->where('country_slug',$admin->country_slug)->orderBy('id','desc')->paginate(15);
	 ...
	 public function complains(Request $request)
    {
        ...
        $customers = Complain::with('user')->where('country_slug',$admin->country_slug)->orderBy('id','desc')->paginate(15);
	 ...
	 public function orders(Request $request)
    {
        ...
        $customers = Order::with('user')->where('country_slug',$admin->country_slug)->orderBy('id','desc')->paginate(15);
   ...
   public function clicks(Request $request)
    {
        ...
        $customers = Click::with('user')->where('country_slug',$admin->country_slug)->orderBy('id','desc')->paginate(15);
   ...
   $admin = Admin::find(auth('admin')->id());
        ...
        $customers = User::where('id',$id)->where('country_slug',$admin->country_slug)->first();
		 $clicks = Click::with('user')->where('user_id',$id)->where('country_slug',$admin->country_slug)->orderBy('id','desc')->paginate(10,['*'], 'clicks');
		 $orders = Order::with('user')->where('user_id',$id)->where('country_slug',$admin->country_slug)->orderBy('id','desc')->paginate(10,['*'], 'orders');
		  $reqs = WithdrawalReq::with('user')->where('user_id',$id)->where('country_slug',$admin->country_slug)->orderBy('id','desc')->paginate(6,['*'], 'reqs');
		 $bankdetails=BankDetail::with('user')->where('user_id',$id)->where('country_slug',$admin->country_slug)->first();
		 $complains=Complain::with('user')->where('user_id',$id)->where('country_slug',$admin->country_slug)->orderBy('id','desc')->paginate(10,['*'], 'complains');
